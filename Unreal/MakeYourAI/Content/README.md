...
`Source/Portraits/elon_max_remade.jpg` is the author-supplied remade likeness of the fictional buyer Elon Max (the character who writes the acquisition ending letter). It is a source still, not an imported `UTexture2D`. Editor import target remains `/Game/Scaffold/Portraits/T_ElonMax_Fictional`.
